...
<body>
	...
	<div><a href="/user/table/info/body/?table=<?=$tableObj->id?>">Структура</a></div>
	<div><a href="/user/table/info/insert/?table=<?=$tableObj->id?>">Вставить строку в таблицу</a></div>
	<div><a href="/user/table/info/fileInsert/?table=<?=$tableObj->id?>">Вставить из xlsx файла.</a></div>
	<div><a href="/user/table/info/editContent/?table=<?=$tableObj->id?>">Редактировать содержимое таблицы</a></div>
	<div><button type="submit" name="submit">Скачать exel file</button></div>
