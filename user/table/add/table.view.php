...
<label>Имя Таблицы: <input type="text" name="tableName" required></label>
<label><input type="hidden" name="userID" required value="<?=$user->id?>"></label>
...
<?php for ($i=0;$i<$validDefaultRows;$i++): ?>   
...
<td><input type="number" name="size[]" value="0" min="0" max="300"></td>
</tr>
<?php endfor; ?>     
</table>
